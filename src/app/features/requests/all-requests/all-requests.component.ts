...
export class AllRequestsComponent implements OnInit {
  ...
  filters: RequestFilters = { estado: 'TODOS', aplicacaoId: 'TODOS', colaboradorId: 'TODOS', pesquisa: '' };
  ...
  load(): void {
    ...
    this.requestsService.getAllRequests({ ...this.filters, page: this.page(), size: 10 }).subscribe({
      next: (result) => {
